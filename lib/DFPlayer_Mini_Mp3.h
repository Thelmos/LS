...
//
void mp3_send_cmd (uint8_t cmd, uint8_t arg1, uint8_t arg2);
...
//play mp3 file in specific folder in your tf card, "mp3_play_from_Folder (1,1);" mean play "0001/0001.mp3"
void mp3_play (uint8_t track, uint8_t folder);
